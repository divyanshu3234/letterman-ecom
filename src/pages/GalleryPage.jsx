      ...
      <div className="gallery-container">
        <div className="gallery-header">
          <h1 className="gallery-title">
            {genderParam ? `${genderParam.toUpperCase()}'S ` : ''} 
            COLLECTION
          </h1>
        ...
        <div className="filter-tabs" role="tablist">
          {[
            ...
            <button
              key={tab.key}
              role="tab"
              aria-selected={currentCat === tab.key}
              className={`filter-tab ${currentCat === tab.key ? 'active' : ''}`}
